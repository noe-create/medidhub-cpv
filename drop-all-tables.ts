...
async function realNuke() {
    console.log("Starting REAL NUCLEAR RESET (Dropping all tables)...");
    ...
    try {
        ...
        console.log("Real Nuclear Reset COMPLETE. Tables will be recreated on next app load.");
    } catch (e) {
        await db.exec('ROLLBACK');
        console.error("Real Nuke failed:", e);
    }
}
