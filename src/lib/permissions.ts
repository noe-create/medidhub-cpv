...
export const ALL_PERMISSIONS: Permission[] = [
  ...
  { id: 'directory.search', name: 'Ver Directorio 360°', description: 'Permite usar el buscador global para visualizar los perfiles directos de los pacientes.', module: 'Admisión' },
  ...
  { id: 'medicalhistory.view', name: 'Ver Historial Médico', description: 'Permite visualizar la cronología clínica directa de las visitas del paciente.', module: 'Atención' },
  { id: 'blankformats.print', name: 'Imprimir Formatos en Blanco', description: 'Permite generar récipes, informes médicos y órdenes listos para rellenar a mano.', module: 'Atención' },
