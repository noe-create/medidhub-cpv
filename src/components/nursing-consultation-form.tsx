  ...
  async function onSubmit(values: NursingProcedureFormValues) {
    ...
    try {
      const createdConsultation = await createConsultation({
        ...
        signosVitales: {
          taSistolica: values.signosVitales.ta ? Number(values.signosVitales.ta.split('/')[0]) : undefined,
          taDiastolica: values.signosVitales.ta ? Number(values.signosVitales.ta.split('/')[1]) : undefined,
          fc: values.signosVitales.fc ? Number(values.signosVitales.fc) : undefined,
          fr: values.signosVitales.fr ? Number(values.signosVitales.fr) : undefined,
          temp: values.signosVitales.temp ? Number(values.signosVitales.temp) : undefined,
          satO2: values.signosVitales.satO2 ? Number(values.signosVitales.satO2) : undefined,
        },
